...
%     R = diag([R_range R_pseudo*ones(1,length(rt_phone1)+length(rt_phone2))]);
    ...
    %call filter
    dt = 1;
    [x_ip1_g_ip1, P_ip1_g_ip1] = moving_KF_heading(x_i_g_i, P_i_g_i, pseudoranges1, pseudoranges2, sat_pos_t1, sat_pos_t2, range, Q,R, dt, theta, v1(:,ind), v2(:,ind));
